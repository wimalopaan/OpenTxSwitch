...
local menu = {
  ...
  pages = {
    ...
    { -- template for digital multiswitch RC-MultiSwitch-D @ Address(1)
      items = {
        {name = "Fun G", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 7, offState = 1, module = 1}},
        {name = "Fun H", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 8, offState = 1, module = 1}},
      }
    },
    { -- template for digital multiswitch RC-MultiSwitch-D @ Address(2)
      items = {
        {name = "Nuf A", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = "sc", count = 1, offState = 1, module = 2}},
        {name = "Nuf B", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = "sd", count = 2, offState = 1, module = 2}},
        {name = "Nuf C", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 3, offState = 1, module = 2}},
        {name = "Nuf D", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = "se", count = 4, offState = 1, module = 2}},
        {name = "Nuf E", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 5, offState = 1, module = 2}},
        {name = "Nuf F", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 6, offState = 1, module = 2}},
      }
    },
    { -- template for digital multiswitch RC-MultiSwitch-D @ Address(2)
      items = {
        {name = "Nuf G", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 7, offState = 1, module = 2}},
        {name = "Nuf H", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 8, offState = 1, module = 2}},
      }
    },
    { -- template for digital multiswitch RC-MultiSwitch-D @ Address(3)
      items = {
        {name = "Ufn A", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = "se", count = 1, offState = 1, module = 3}},
        {name = "Ufn B", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = "sg", count = 2, offState = 1, module = 3}},
        {name = "Ufn C", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 3, offState = 1, module = 3}},
        {name = "Ufn D", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 4, offState = 1, module = 3}},
        {name = "Ufn E", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 5, offState = 1, module = 3}},
        {name = "Ufn F", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 6, offState = 1, module = 3}},
      }
    },
    { -- template for digital multiswitch RC-MultiSwitch-D @ Address(3)
      items = {
        {name = "Ufn G", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 7, offState = 1, module = 3}},
        {name = "Ufn H", states = {"aus", "ein", "b1", "b2"}, state = 1, cb = nil, data = {switch = nil, count = 8, offState = 1, module = 3}},
      }
    },
